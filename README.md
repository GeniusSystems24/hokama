...
- **الأعمدة**:
    - `EntityID`: معرف الكيان الذي تنتمي إليه المجموعة (INT) `مفتاح أساسي مركب ومفتاح خارجي`
...
- **الأعمدة**:
    ...
    - `StudentID`: معرف الطالب (INT) `مفتاح خارجي`
...
- **الأعمدة**:
    - `EntityID`: معرف الكيان الذي تنتمي إليه المجموعة (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `DomainID`: معرف المجال الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
...
- **الأعمدة**:
    - `EntityID`: معرف الكيان الذي تنتمي إليه المجموعة (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `DomainID`: معرف المجال الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `SectionID`: معرف القسم الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
...
- **الأعمدة**:
    ...
    - `DomainID`: معرف المجال الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `SectionID`: معرف القسم الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `TopicID`: معرف الموضوع الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `CompetitionID`: معرف المسابقة الفريد (INT) `مفتاح أساسي`
...
- **الأعمدة**:
    ...
    - `SectionID`: معرف القسم الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `TopicID`: معرف الموضوع الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `CompetitionID`: معرف المسابقة الفريد (INT) `مفتاح أساسي مركب ومفتاح خارجي مركب`
    - `UserID`: معرف المستخدم (INT) `مفتاح أساسي مركب ومفتاح خارجي`
...
- **الأعمدة**:
    - `SubscriptionID`: معرف الاشتراك الفريد (INT)
    - `PlanID`: معرف الخطة (INT)
    - `EntityID`: معرف الكيان (INT)
...
- **الأعمدة**:
    - `PaymentID`: معرف الدفع الفريد (INT)
    - `SubscriptionID`: معرف الاشتراك المرتبط (INT)
