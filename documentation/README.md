...
#### **أولاً: أدوات متاحة لمسؤول المنصة**
...
#### **ثانياً: أدوات متاحة لمسؤول الجهة**
...
| **إدارة المحتوى**               | انشاء وتعديل محتوى المنصة                         | إعداد وتحديث المحتوى الخاص بالجهة            | الوصول إلى المحتوى المتاح فقط               |
...
- **مسؤول المنصة**: يركز على إدارة النظام والبنية الأساسية للمنصة، بما في ذلك إعداد الباقات وتخصيص الصلاحيات.
- **مسؤول الجهة**: يتحكم في إدارة الطلاب والمعلمين داخل مؤسسته، مع مسؤولية إعداد المحتوى وتتبع الأداء.
...
### 1. **باقات اشتراك خاصة بالطلاب (اشتراكات فردية)**
...
### 2. **باقات اشتراك خاصة بالجهات (باقات للمؤسسات التعليمية)**
...
**تمثيل تسلسلي (Sequence Diagram)**:

```
مسؤول النظام -> لوحة التحكم: تسجيل الدخول
مسؤول النظام -> إدارة الباقات: الوصول إلى قسم الباقات
مسؤول النظام -> إنشاء باقة: إدخال التفاصيل والميزات
مسؤول النظام -> حفظ الباقة: حفظ وتفعيل الباقة
```
...
```
مسؤول النظام -> لوحة التحكم: تسجيل الدخول
مسؤول النظام -> إدارة التراخيص: الوصول إلى التراخيص
مسؤول النظام -> قائمة الجهات: اختيار الجهة/المستخدم
مسؤول النظام -> تعديل الحالة: تفعيل/إيقاف الترخيص
مسؤول النظام -> تأكيد: تأكيد العملية
```
...
```
مسؤول النظام -> لوحة التحكم: تسجيل الدخول
مسؤول النظام -> إدارة الجهات: الوصول إلى الجهات
مسؤول النظام -> إضافة جهة: إدخال معلومات الجهة
مسؤول النظام -> تحديد الباقة: اختيار الباقة
مسؤول النظام -> حفظ: حفظ وإرسال التفاصيل
نظام -> مسؤول الجهة: إرسال تفاصيل تسجيل الدخول
```
...
```
مسؤول النظام -> لوحة التحكم: تسجيل الدخول
مسؤول النظام -> إدارة المستخدمين: الوصول إلى المستخدمين
مسؤول النظام -> إضافة مستخدم: إدخال تفاصيل المسؤول
مسؤول النظام -> تخصيص الصلاحيات: تحديد الصلاحيات
مسؤول النظام -> حفظ: حفظ وإشعار المستخدم
نظام -> مسؤول الجهة: إرسال تفاصيل الحساب
```
...
```
مسؤول النظام -> لوحة التحكم: تسجيل الدخول
مسؤول النظام -> التقارير: الوصول إلى قسم التقارير
مسؤول النظام -> تحديد التقرير: اختيار نوع وفترة التقرير
مسؤول النظام -> عرض التقرير: استعراض البيانات
مسؤول النظام -> تنزيل/مشاركة: اتخاذ إجراء مناسب
```
...
```
مسؤول الجهة -> لوحة التحكم: تسجيل الدخول
مسؤول الجهة -> إدارة المستخدمين: الوصول إلى المستخدمين
مسؤول الجهة -> إضافة مستخدم: إدخال تفاصيل المستخدم
مسؤول الجهة -> ربط بالمجموعات: تحديد المجموعات
مسؤول الجهة -> حفظ: حفظ وإشعار المستخدم
نظام -> المستخدم: إرسال تفاصيل الحساب
```
...
```
مسؤول الجهة -> إدارة المجموعات: الوصول إلى المجموعات
مسؤول الجهة -> إضافة مجموعة: إدخال تفاصيل المجموعة
مسؤول الجهة -> تحديد المجالات: اختيار المجالات الدراسية
مسؤول الجهة -> إضافة أعضاء: إضافة الطلاب والمعلمين
مسؤول الجهة -> حفظ: حفظ المجموعة
```
...
```
مسؤول الجهة -> إدارة المحتوى: الوصول إلى المحتوى
مسؤول الجهة -> اختيار المجموعة: تحديد المجموعة المستهدفة
مسؤول الجهة -> تخصيص المحتوى: تعديل المجالات والمواضيع
مسؤول الجهة -> إعداد المسابقات: إنشاء وتخصيص المسابقات
مسؤول الجهة -> حفظ: حفظ التعديلات
```
...
```
مسؤول الجهة -> تقارير الأداء: الوصول إلى التقارير
مسؤول الجهة -> اختيار المجموعة/الطالب: تحديد الهدف
مسؤول الجهة -> عرض التقرير: استعراض البيانات
مسؤول الجهة -> تحليل البيانات: تحديد النقاط الهامة
مسؤول الجهة -> اتخاذ الإجراءات: إعادة تخصيص الأنشطة
```
...
```
طالب -> صفحة الدخول: إدخال بيانات التسجيل
طالب -> الصفحة الرئيسية: الوصول إلى المقررات
طالب -> اختيار المجال: تحديد المجال التعليمي
طالب -> اختيار الموضوع: تحديد الموضوع
طالب -> المحتوى: استعراض المواد التعليمية
```
...
```
نظام -> طالب: إرسال إشعار بالتمرين
طالب -> التمارين: الوصول إلى قسم التمارين
طالب -> اختيار التمرين: تحديد التمرين المطلوب
طالب -> بدء التمرين: بدء الإجابة
طالب -> إرسال الإجابات: إكمال التمرين
نظام -> طالب: إرسال النتائج
```
...
```
طالب -> لوحة التقدم: الوصول إلى التقدم الشخصي
طالب -> استعراض التقارير: مشاهدة البيانات
طالب -> تحليل الأداء: تحديد النقاط الهامة
طالب -> خطة التحسين: اتخاذ إجراءات للتحسين
```
